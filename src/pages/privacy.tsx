  ...
  return (
    <div className="flex-grow container py-6 md:py-16">
      <div className="space-y-0.5">
        ...
        <p className="text-muted-foreground">Last updated October 1st, 2023</p>
      </div>
      ...
      <div className="prose lg:prose-xl dark:prose-invert">
        ...
        <h3>Interpretation & Definitions</h3>
        ...
        <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
          ...
          <li>
            <p className="leading-7">
              ...
              "We", "Us" or "Our" in this Agreement) refers to WordleDash.io
            </p>
            <p className="leading-7">
          ...
          <li>
            <p className="leading-7">
              <strong>"Website"</strong> refers to Wordle Dash, accessible from
              https://wordledash.io
            </p>
          </li>
          <li>
        ...
        <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
          ...
          <li>
            ...
            <p className="leading-7">Type: Persistent Cookies</p>
            <p className="leading-7">Administered by: Third-Parties</p>
            <p>
        ...
        <h4>Ads</h4>
        <p>
          Advertisements Ads appearing on our website may be delivered to users
          by advertising partners, who may set cookies. These cookies allow the
          ad server to recognize your computer each time they send you an online
          ...
          Company and does not cover the use of cookies by any advertisers.
        </p>
        <ul>
        ...
        <ul>
          <li>
            ...
            <a href="mailto:hello@wordledash.io">hello@wordledash.io</a>
          </li>
        </ul>
        <p></p>
      </div>
